/*Show summary part of article
preventDefault: prevent default behavior of browser, reloading application*/
...
const Demo = () => {
  ...
  //Dependency array empty meaning execute at start of application
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(data?.summary) {
      const newArticle = {...article, summary: data.
        ...
        allArticles]; //Pushing new article to all articles array
    ...
    <section className="mt-16 w-full max-w-x1">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        overflow-y-auto"> 
          {allArticles.map((item, index) => (
            <div
              key={`link-${index}`}
              onClick={() => setArticle(item)} //Get back to article you previously visited
              className="link_card"
            > 
      ...
      items-center">
        {isFetching ? (
          ...
          <p className="font-inter font-bold text-red-600 
          text-center">
